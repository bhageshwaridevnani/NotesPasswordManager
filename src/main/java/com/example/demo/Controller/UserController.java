...
public class UserController extends BaseController{
    ...
    @ApiOperation(value = "Verify user",
            ...
            produces = "application/json",
            authorizations = {@Authorization(value = Constant.API_KEY)})
    public ResponseEntity<?> checkSecurity(@Validated @RequestBody SecurityDTO securityDTO ) throws Exception {
        return okSuccessResponse(userService.verifyUser(securityDTO),"Verify user");
    }
}
